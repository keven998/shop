            ...
            <div class="container-fluid">
                <div class="info-center">
                    <div class="page-header clearfix">
                        <div class="pull-left">
                            <h4>区域管理</h4>      
                            <?php if($parent[level] > 0): ?><a href="<?php echo U('system/region',array('parent_id'=>$parent[parent_id]));?>">
                    ...
                    <div class="search-box row">
                        <div class="col-md-8">
                            <form action="<?php echo U('system/regionHandle');?>" method="post">
                    ...
                    <div class="table-margin">
                        <div class="row">
                            <?php if(is_array($region)): foreach($region as $k=>$vo): ?><div class="col-sm-3" style="padding:10px">
                                    <label class="margin" style="width:100px;display:inline-block;text-align:right"><?php echo ($vo["name"]); ?></label>
                                    <?php if($vo[level] < 4): ?><a href="<?php echo U('system/region',array('parent_id'=>$vo[id]));?>" class="btn btn-info" role="button">管理</a>
                                        &nbsp;&nbsp;<?php endif; ?>
                                    <a href="javascript:void(0);" data-url="<?php echo U('system/regionHandle',array('id'=>$vo[id]));?>" onclick="delRegion(this)" class="btn btn-default" role="button">删除</a>
