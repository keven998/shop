            ...
            <div class="container-fluid">
                <div class="info-center">
                    ...
                    <div class="table-margin">
                        <?php echo ($comment["username"]); ?> 于 <?php echo (date("Y-m-d H:i:s",$comment["add_time"])); ?> 对 <strong><?php echo ($comment["goods_name"]); ?></strong> 发表评论 物流评价<?php echo ($comment["deliver_rank"]); ?>分 商品评价<?php echo ($comment["goods_rank"]); ?>分 服务评价<?php echo ($comment["service_rank"]); ?>分
                        <hr />
                        <div class="com-content">
                            <?php echo ($comment["content"]); ?>
                        </div>
                        <?php if(is_array($reply)): foreach($reply as $key=>$vo): echo ($vo["username"]); ?> 于 <?php echo (date("Y-m-d H:i:s",$vo["add_time"])); ?> 发表回复
                        <hr />
                        <div class="com-content">
                            <?php echo ($vo["content"]); ?>
                            ...
                            <table class="table  contact-template-form">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <textarea name="content" class="form-control w-300"><?php echo ($reply["content"]); ?></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="10%"></td>
                                        <td>
                                            ...
                                            <input type="hidden" name="goods_id" value="<?php echo ($comment["goods_id"]); ?>" />
