                            ...
                            <table class="table table-hover table-header">
                                ...
                                <tbody>
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>-</td>
                                            <td class="action">
                                                <a class="db-import" href="<?php echo U('database/import',array('time'=>$data['time']));?>">还原</a>
                                                <span class="text-explode">|</span>
                                                <a class="ajax-get confirm" href="<?php echo U('database/del',array('time'=>$data['time']));?>">删除</a>
                                            </td>
