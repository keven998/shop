            ...
            <div class="container-fluid">
                <div class="info-center">
                    <div class="page-header clearfix">
                        ...
                        <a href="<?php echo U('wechat/addMenu');?>" class="btn btn-primary pull-right margin-top">添加菜单</a>
                        <a href="<?php echo U('wechat/upMenu');?>" class="btn btn-primary pull-right margin-top" style="margin-right:20px;">更新微信菜单</a>
                    </div>
                        ...
                        <table class="table table-hover table-header">
                            ...
                            <?php if($menu): ?><tbody>
                                    <?php if(is_array($menu)): foreach($menu as $key=>$vo): ?><tr>
                                            ...
                                            <td>
                                                <?php if($vo['type'] == 'scancode_push'): ?>扫码推事件<?php endif; ?>
                                                <?php if($vo['type'] == 'click'): ?>点击推事件<?php endif; ?>
                                                <?php if($vo['type'] == 'view'): ?>跳转URL<?php endif; ?>
                                            </td>
                                            <td><?php if($vo['key']): echo ($vo["key"]); else: ?>-<?php endif; ?></td>
                                            <td><?php if($vo['url']): echo ($vo["url"]); else: ?>-<?php endif; ?></td>                        
                                            <td>
                                                <a href="<?php echo U('wechat/editMenu',array('id'=>$vo['id']));?>">编辑</a>
                                                <span class="text-explode">|</span>
                                                <a href="<?php echo U('wechat/delMenu',array('id'=>$vo['id']));?>">删除</a>
                                            </td>
