                ...
                <div class="info-center">
                    ...
                    <div class="table-margin">
                        <table class="table table-hover table-header">
                            ...
                            <tbody>
                                <?php if(is_array($shipping)): foreach($shipping as $key=>$vo): ?><tr>
                                        <td><?php echo ($vo["name"]); ?></td>
                                        <td><?php echo ($vo["desc"]); ?></td>  
                                        <td>
                                            <?php if($vo['status'] == 0): ?><p><a onclick="installPlugin('<?php echo ($vo["type"]); ?>','<?php echo ($vo["code"]); ?>',1)" href="#" class="btn btn-primary" role="button">一键安装</a> </p>
                                                <?php else: ?>
                                                <p><a onclick="installPlugin('<?php echo ($vo["type"]); ?>','<?php echo ($vo["code"]); ?>',0)" href="#" class="btn btn-danger" role="button">卸载</a>
                                                    <a href="<?php echo U('Admin/system/shipping_list',array('type'=>$vo['type'],'code'=>$vo['code']));?>" class="btn btn-primary" role="button">配置</a>
                                                    <a href="<?php echo U('Admin/system/shipping_print',array('type'=>$vo['type'],'code'=>$vo['code']));?>" class="btn btn-primary" role="button">模板编辑</a>
                                                </p><?php endif; ?>
                                        </td>
