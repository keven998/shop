            ...
            <div class="container-fluid">
                <div class="info-center">
                    <div class="page-header clearfix">
                        ...
                        <a href="<?php echo U('goods/addGoods');?>" class="btn btn-primary pull-right ">添加商品</a>
                    </div>
                            ...
                            <form action="" method="get">
                                <div class="form-group">
                                    <select class="form-control" name="cat_id">
                                        ...
                                        <?php if(is_array($category)): foreach($category as $key=>$vo): ?><option value="<?php echo ($vo["cat_id"]); ?>"><?php echo ($vo["html"]); echo ($vo["cat_name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="intro">
                                        ...
                                        <option value="is_new" <?php if($_GET['intro']== 'is_new'): ?>selected<?php endif; ?>>新品</option>
                                        <option value="is_recommend" <?php if($_GET['intro']== 'is_recommend'): ?>selected<?php endif; ?>>推荐</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <span class="pull-left form-span">关键词:</span>
                                    <input type="text" name="goods_name" value="<?php echo ($_GET['goods_name']); ?>" class="form-control" placeholder="请输入关键词">
                                </div>
                        ...
                        <table class="table table-hover table-header">
                            ...
                            <?php if($list['data']): ?><tbody>
                                    <?php if(is_array($list["data"])): foreach($list["data"] as $key=>$vo): ?><tr>
                                            ...
                                            <td><input type="text" onchange="updateSort('goods','goods_id','<?php echo ($vo["goods_id"]); ?>','goods_number',this)" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')"  size="4" value="<?php echo ($vo["goods_number"]); ?>" class="form-control" style="width:80px" /></td>
                                            <td>                        
                                                <img width="20" height="20" src="/Public/Admin/images/<?php if($vo[is_on_sale] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('goods','goods_id','<?php echo ($vo["goods_id"]); ?>','is_on_sale',this)"/>
                                            </td>
                                            <td>
                                                <img width="20" height="20" src="/Public/Admin/images/<?php if($vo[is_recommend] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('goods','goods_id','<?php echo ($vo["goods_id"]); ?>','is_recommend',this)"/>
                                            </td>
                                            <td>
                                                <img width="20" height="20" src="/Public/Admin/images/<?php if($vo[is_new] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('goods','goods_id','<?php echo ($vo["goods_id"]); ?>','is_new',this)"/>
                                            </td>
                                            <td>
                                                <img width="20" height="20" src="/Public/Admin/images/<?php if($vo[is_hot] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('goods','goods_id','<?php echo ($vo["goods_id"]); ?>','is_hot',this)"/>
                                            </td>            
                                            <td>
                                                <!-- <a href="<?php echo U('goods/detail',array('goods_id'=>$vo['goods_id']));?>">查看</a>
                                                <span class="text-explode">|</span> -->
                                                <a href="<?php echo U('goods/editGoods',array('goods_id'=>$vo['goods_id']));?>">编辑</a>
                                                <span class="text-explode">|</span>
                                                <a href="<?php echo U('goods/delGoods',array('goods_id'=>$vo['goods_id']));?>">删除</a>
                                            </td>
                                        </tr><?php endforeach; endif; ?>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        <td colspan="13" align="right"><?php echo ($list["page"]); ?></td>
                                    </tr>
                                </tfoot>
                            <?php else: ?>
                                <tr>
