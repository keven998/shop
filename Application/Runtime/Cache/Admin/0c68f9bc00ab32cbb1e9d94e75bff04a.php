                ...
                <div class="info-center">
                    ...
                    <div class="table-margin">
                        <table class="table table-hover table-header" id="list-table">
                            ...
                            <tbody>
                                <?php if($list['data']): if(is_array($list["data"])): foreach($list["data"] as $key=>$vo): ?><tr>
                                            <td><input type="checkbox" name="selected[]" value="<?php echo ($vo["comment_id"]); ?>"></td>
                                            <td><?php echo ($vo["username"]); ?></td>
                                            <td><?php echo ($vo["content"]); ?></td>
                                            <td><a target="_blank" href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$vo[goods_id]));?>"><?php echo ($vo["goods_name"]); ?></a></td>
                                            <td><img width="20" height="20" src="/Public/Admin/images/<?php if($vo[is_show] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('comment','comment_id','<?php echo ($vo["comment_id"]); ?>','is_show',this)"/></td>
                                            <td><?php echo (date('Y-m-d H:i:s',$vo["add_time"])); ?></td>
                                            <td><?php echo ($vo["ip_address"]); ?></td>
                                            <td>
                                                <a href="<?php echo U('goods/detailComment',array('id'=>$vo['comment_id']));?>">详情</a>
                                                <span class="text-explode">|</span>
                                                <a href="<?php echo U('goods/delComment',array('id'=>$vo['comment_id']));?>">删除</a>
                                            </td>
