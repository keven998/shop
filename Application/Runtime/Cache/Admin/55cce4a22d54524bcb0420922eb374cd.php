                    ...
                    <div class="search-box row">
                        <div class="col-md-8">
                            <form action="" method="get">
                                ...
                                <div class="form-group">
                                    <span class="pull-left form-span">收款账号:</span>
                                    <input type="text" name="account_bank" value="<?php echo ($_GET['account_bank']); ?>" class="form-control" placeholder="请输入收款账号">
                                </div>
                                <div class="form-group">
                                    <span class="pull-left form-span">收款账户名:</span>
                                    <input type="text" name="account_name" value="<?php echo ($_GET['account_name']); ?>" class="form-control" placeholder="请输入收款账户名">
                                </div>
