            ...
            <div class="container-fluid">
                <div class="info-center">
                    <div class="page-header clearfix">
                        ...
                        <a href="<?php echo U('goods/addGoodsType');?>" class="btn btn-primary pull-right ">添加商品类型</a>
                    </div>
                        ...
                        <table class="table table-hover table-header">
                            ...
                            <?php if($list['data']): ?><tbody>
                                    <?php if(is_array($list["data"])): foreach($list["data"] as $key=>$vo): ?><tr>
                                            ...
                                            <td>
                                                <a href="<?php echo U('goods/goodsAttributeList',array('type_id'=>$vo['id']));?>">属性</a>
                                                <span class="text-explode">|</span>
                                                <a href="<?php echo U('goods/editGoodsType',array('id'=>$vo['id']));?>">编辑</a>
                                                <span class="text-explode">|</span>
                                                <a href="<?php echo U('goods/delGoodsType',array('id'=>$vo['id']));?>">删除</a>
                                            </td>
                                        </tr><?php endforeach; endif; ?>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        <td colspan="3" align="right"><?php echo ($list["page"]); ?></td>
                                    </tr>
                                </tfoot>
                            <?php else: ?>
                                <tr>
