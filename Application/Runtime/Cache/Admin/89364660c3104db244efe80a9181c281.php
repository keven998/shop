            ...
            <div class="container-fluid">
                <div class="info-center">
                    <div class="page-header clearfix">
                        ...
                        <a href="<?php echo U('goods/addBrand');?>" class="btn btn-primary pull-right ">添加品牌</a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <form action="" method="get">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="brand_name" value="<?php echo ($_GET['brand_name']); ?>" class="form-control" placeholder="请输入关键词">
                                </div>
                        ...
                        <table class="table table-hover table-header">
                            ...
                            <?php if($list['data']): ?><tbody>
                                    <?php if(is_array($list["data"])): foreach($list["data"] as $key=>$vo): ?><tr>
                                            ...
                                            <td><a href="<?php echo ($vo["brand_logo"]); ?>" target="_blank"><img src="<?php echo ($vo["brand_logo"]); ?>" width="20px" height="20px" alt="" /></a></td>
                                            <td><img width="20" height="20" src="/Public/Admin/images/<?php if($vo[is_show] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('brand','brand_id','<?php echo ($vo["brand_id"]); ?>','is_show',this)"/></td>
                                           
                                            <td><?php echo ($vo["sort"]); ?></td>                                            
                                            <td>
                                                <a href="<?php echo U('goods/editBrand',array('brand_id'=>$vo['brand_id']));?>">编辑</a>
                                                <span class="text-explode">|</span>
                                                <a href="<?php echo U('goods/delBrand',array('brand_id'=>$vo['brand_id']));?>">删除</a>
                                            </td>
