            ...
            <div class="container-fluid">
                <div class="info-center">
                    <div class="page-header clearfix">
                        ...
                        <a href="<?php echo U('wechat/addText');?>" class="btn btn-primary pull-right margin-top">添加关键词</a>
                    </div>
                        ...
                        <table class="table table-hover table-header">
                            ...
                            <?php if($list['data']): ?><tbody>
                                    <?php if(is_array($list["data"])): foreach($list["data"] as $key=>$vo): ?><tr>
                                            ...
                                            <td><?php if($vo['type'] == 2): ?><img src="<?php echo ($vo["cover"]); ?>" alt="" width="100" height="30"><?php endif; ?></td>
                                            <td><?php echo (getSubstr($vo["content"],0,30)); ?></td>                      
                                            <td>
                                                <a href="<?php echo U('wechat/editText',array('id'=>$vo['id']));?>">编辑</a>
                                                <span class="text-explode">|</span>
                                                <a href="<?php echo U('wechat/delText',array('id'=>$vo['id']));?>">删除</a>
                                            </td>
