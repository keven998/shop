...
<body>
            ...
            <div class="container-fluid">
                <div class="info-center">
                    ...
                    <div class="table-margin">
                        <form action="<?php echo U('goods/addBrand');?>" class="form-horizontal" method="post" onsubmit="return checkName();" id="addEditBrandForm">
                            ...
                            <table class="table table-hover contact-template-form">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="brand_name" value="<?php echo ($brand["brand_name"]); ?>" class="form-control w-300" placeholder="">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="20%" align="right">品牌网址：</td>
                                        <td>
                                            <input type="text" name="site_url" value="<?php echo ($brand["brand_name"]); ?>" class="form-control w-300" placeholder="">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="20%" align="right">品牌LOGO：</td>
                                        <td>
                                            <div class="col-sm-3">                                                                              
                                                <input type="text" value="<?php echo ($brand["brand_logo"]); ?>" name="brand_logo" id="brand_logo" class="form-control" style="width:350px;margin-left:-15px;"/>
                                            </div>
                                            <div class="col-sm-3">
                                                <input onclick="GetUploadify(1,'brand_logo','brand');" type="button" class="btn btn-default" value="上传logo"/>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="20%" align="right">品牌排序：</td>
                                        <td>
                                            <input type="text" name="sort" value="<?php echo ($brand["sort"]); ?>" class="form-control w-300" placeholder="">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="20%" align="right">品牌描述：</td>
                                        <td>
                                            <textarea class="form-control w-300" name="brand_desc"><?php echo ($brand["brand_desc"]); ?></textarea>
                                        </td>
                                    </tr>                                    
                                    <tr>
                                        ...
                                        <td>
                                            <label class="radio-inline">
                                                <input type="radio" name="is_show" id="inlineRadio1" value="0" <?php if($brand['is_show'] == 0): ?>checked<?php endif; ?>> 隐藏
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="is_show" id="inlineRadio2" value="1"  <?php if($brand['is_show'] == 1): ?>checked<?php endif; ?>> 显示
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
    ...
    // 判断输入框是否为空
    function checkName(){
        var name = $("#addEditBrandForm").find("input[name='brand_name']").val();
        if($.trim(name) == '')
        {
            layer.msg('品牌名称不能为空！')
            return false;
