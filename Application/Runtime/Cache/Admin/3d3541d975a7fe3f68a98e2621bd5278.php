            ...
            <div class="container-fluid">
                <div class="info-center">
                    ...
                    <div class="search-box row">
                        <div class="col-md-8">
                            <form action="" method="get">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="keywords" value="<?php echo ($_GET['keywords']); ?>" class="form-control" placeholder="请输入关键词">
                                </div>
                        ...
                        <div class="col-md-4">
                            <a href="<?php echo U('system/addLink');?>" class="btn btn-primary pull-right ">添加友链</a>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                        ...
                        <table class="table table-hover table-header">
                            ...
                            <?php if($list['data']): ?><tbody>
                                    <?php if(is_array($list["data"])): foreach($list["data"] as $key=>$vo): ?><tr>
                                            ...
                                            <td>                        
                                                <img width="20" height="20" src="/Public/Admin/images/<?php if($vo[target] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('friendLink','link_id','<?php echo ($vo["link_id"]); ?>','target',this)"/>
                                            </td>   
                                            <td>                        
                                                <img width="20" height="20" src="/Public/Admin/images/<?php if($vo[is_show] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('friendLink','link_id','<?php echo ($vo["link_id"]); ?>','is_show',this)"/>
                                            </td>     
                                            <td><input type="text" onchange="updateSort('friendLink','link_id','<?php echo ($vo["link_id"]); ?>','orderby',this)" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')"  size="4" value="<?php echo ($vo["orderby"]); ?>" class="form-control" style="width:80px" /></td>   
                                            <td>
                                                <a href="<?php echo U('system/editLink',array('link_id'=>$vo['link_id']));?>">编辑</a>
                                                <span class="text-explode">|</span>
                                                <a href="<?php echo U('system/delLink',array('link_id'=>$vo['link_id']));?>">删除</a>
                                            </td>
                                        </tr><?php endforeach; endif; ?>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        <td colspan="7" align="right"><?php echo ($list["page"]); ?></td>
                                    </tr>
                                </tfoot>
                            <?php else: ?>
                                <tr>
