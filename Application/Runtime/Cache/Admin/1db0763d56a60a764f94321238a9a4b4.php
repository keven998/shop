            ...
            <div class="container-fluid">
                <div class="info-center">
                    ...
                    <div class="table-margin">
                        <form action="<?php echo U('admin/editUser');?>" class="form-horizontal" method="post">
                                    ...
                                    <!--<tr>
                                        ...
                                        <td>
                                            <select class="form-control w-300" name="rid">
                                                <?php if(is_array($role)): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $data['role'][0]['id']): ?>selected<?php endif; ?>><?php echo ($vo["remark"]); ?>(<?php echo ($vo["name"]); ?>)</option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </td>
                                    </tr>-->
                                    <tr>
                                        ...
                                        <td>
                                            <label class="radio-inline">
                                                <input type="radio" name="lock" id="inlineRadio1" value="0" <?php if(!$vo['lock']): ?>checked<?php endif; ?>> 正常
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="lock" id="inlineRadio2" value="1" <?php if($vo['lock']): ?>checked<?php endif; ?>> 冻结
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
