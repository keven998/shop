            ...
            <div class="container-fluid">
                <div class="info-center">
                    <div class="page-header clearfix">
                        ...
                        <a href="<?php echo U('user/addRank');?>" class="btn btn-primary pull-right">添加等级</a>
                    </div>
                        ...
                        <table class="table table-hover table-header">
                            ...
                            <?php if($list['data']): ?><tbody>
                                    <?php if(is_array($list["data"])): foreach($list["data"] as $key=>$vo): ?><tr>
                                            ...
                                            <td>
                                                <a href="<?php echo U('user/editRank',array('rank_id'=>$vo['rank_id']));?>">编辑</a>
                                                <span class="text-explode">|</span>
                                                <a href="<?php echo U('user/delRank',array('rank_id'=>$vo['rank_id']));?>">删除</a>
                                            </td>
