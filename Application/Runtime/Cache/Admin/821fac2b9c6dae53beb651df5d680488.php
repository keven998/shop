            ...
            <div class="container-fluid">
                <div class="info-center">
                    <div class="page-header clearfix">
                        ...
                        <a href="<?php echo U('goods/addGoodsAttribute');?>" class="btn btn-primary pull-right ">添加商品属性</a>
                    </div>
                            ...
                            <form action="" method="get">
                                <div class="form-group">
                                    ...
                                    <select name="type_id" id="" class="form-control">
                                        ...
                                        <?php if(is_array($goodsTypeList)): foreach($goodsTypeList as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if($_GET['type_id']== $vo['id']): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                        ...
                        <table class="table table-hover table-header">
                            ...
                            <?php if($list['data']): ?><tbody>
                                    <?php if(is_array($list["data"])): foreach($list["data"] as $key=>$vo): ?><tr>
                                            ...
                                            <td class="text-left"><?php echo ($vo["attr_name"]); ?></td>
                                            <td class="text-left"><?php echo ($vo["typeName"]); ?></td>
                                            <td class="text-left"><?php echo ($attr_input_type[$vo[attr_input_type]]); ?></td>
                                            <td class="text-left"><?php echo (mb_substr($vo["attr_values"],0,30,'utf-8')); ?></td> 
                                            <td>
                                                <?php if($vo['attr_index'] == 1): ?><span class="glyphicon glyphicon-ok text-success"></span>
                                                <?php else: ?>
                                                    <span class="glyphicon glyphicon-remove text-warning"></span><?php endif; ?>
                                            </td>                      
                                            <td><input type="text" onchange="updateSort('goods_attribute','attr_id','<?php echo ($vo["attr_id"]); ?>','sort',this)" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')"  size="4" value="<?php echo ($vo["sort"]); ?>" class="form-control" style="width:80px" /></td>                      
                                            <td>
                                                <a href="<?php echo U('goods/editGoodsAttribute',array('attr_id'=>$vo['attr_id']));?>">编辑</a>
                                                <span class="text-explode">|</span>
                                                <a href="<?php echo U('goods/delGoodsAttribute',array('attr_id'=>$vo['attr_id']));?>">删除</a>
                                            </td>
                                        </tr><?php endforeach; endif; ?>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        <td colspan="8" align="right"><?php echo ($list["page"]); ?></td>
                                    </tr>
                                </tfoot>
                            <?php else: ?>
                                <tr>
