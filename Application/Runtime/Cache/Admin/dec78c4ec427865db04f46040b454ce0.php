            ...
            <div class="container-fluid">
                <div class="info-center">
                    <div class="page-header clearfix">
                        ...
                        <a href="<?php echo U('goods/addSpec');?>" class="btn btn-primary pull-right ">添加商品规格</a>
                    </div>
                        ...
                        <table class="table table-hover table-header">
                            ...
                            <?php if($list['data']): ?><tbody>
                                    <?php if(is_array($list["data"])): foreach($list["data"] as $key=>$vo): ?><tr>
                                            ...
                                            <td><?php echo ($vo["spec_item"]); ?></td>                      
                                            <td><input type="text" onchange="updateSort('spec','id','<?php echo ($vo["id"]); ?>','sort',this)" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')"  size="4" value="<?php echo ($vo["sort"]); ?>" class="form-control" style="width:80px" /></td>                      
                                            <td>
                                                <a href="<?php echo U('goods/editSpec',array('id'=>$vo['id']));?>">编辑</a>
                                                <span class="text-explode">|</span>
                                                <a href="<?php echo U('goods/delSpec',array('id'=>$vo['id']));?>">删除</a>
                                            </td>
                                        </tr><?php endforeach; endif; ?>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        <td colspan="6" align="right"><?php echo ($list["page"]); ?></td>
                                    </tr>
                                </tfoot>
                            <?php else: ?>
                                <tr>
